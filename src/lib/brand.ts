...
export const PLATFORM_NAME = "Khulisa Community";
export const PLATFORM_TAGLINE =
  "Supporting Skills, Mentorship, Apprenticeships and Community Opportunities";

export const POWERED_BY_LINE = "Powered by Khulisa Community";
export const GROUP_PLATFORM_LINE = "A Khulisa Group Platform";

export const PROGRAMME_NAME = "Hineni Programme";
export const PROGRAMME_BYLINE = "Hineni Programme powered by Khulisa Community";
export const DELIVERED_THROUGH_LINE = "Delivered through the Khulisa Community Platform";
