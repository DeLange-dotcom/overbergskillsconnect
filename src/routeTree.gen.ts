...
const ApprenticeshipsRegisterProviderRoute =
  ApprenticeshipsRegisterProviderRouteImport.update({
    ...
    path: '/apprenticeships/register-provider',
    getParentRoute: () => rootRouteImport,
  } as any)
