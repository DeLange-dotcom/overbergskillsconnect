...
// The platform is owned and operated by Khulisa Group.
// Hineni is a programme delivered THROUGH the platform — not the platform owner.

export const PLATFORM_OWNER = "Khulisa Group";
export const PLATFORM_NAME = "Khulisa Community Connect";
export const PLATFORM_TAGLINE =
  "Supporting Skills, Mentorship, Apprenticeships and Community Opportunities";

export const POWERED_BY_LINE = "Powered by Khulisa Community Connect";
export const GROUP_PLATFORM_LINE = "A Khulisa Group Platform";

export const PROGRAMME_NAME = "Hineni Programme";
export const PROGRAMME_BYLINE = "Hineni Programme powered by Khulisa Community Connect";
export const DELIVERED_THROUGH_LINE = "Delivered through the Khulisa Community Connect Platform";
